...
- Added consistent one-, two-, and three-line cable labels.
- Added direct USB printing through `ptouch-rs` for the Brother PT-D600.
- Added persistent macOS installation and optional tailnet-only access.
