...
check-common: test
	bash -n scripts/build-linux-app.sh scripts/install-linux-service.sh scripts/verify-linux-app.sh
...
check-linux: check-common
	shellcheck scripts/build-linux-app.sh scripts/install-linux-service.sh scripts/verify-linux-app.sh
